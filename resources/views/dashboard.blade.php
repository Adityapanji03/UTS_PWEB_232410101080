    ...
    <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="profileMenu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                            ...
                            <a href="#" class="block px-4 py-2 text-sm text-blue-300 hover:bg-gray-100">Sign out</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="flex-1 overflow-y-auto p-4">
            <div class="bg-white p-6 rounded-lg shadow">
                <h1 class="text-2xl font-bold text-gray-800">Welcome to Dashboard, {{ request()->query('username') }}!</h1>
                <p class="text-gray-600 mt-2">Semoga harimu menyenangkan ygy.</p>
            </div>
        </main>
    </div>
