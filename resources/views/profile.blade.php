        ...
        <main class="flex-1 overflow-y-auto p-4">
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="username" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ request()->query('username') }}" readonly>
                </div>
                <div class="mb-4">
                    <label for="password" class="block text-gray-600 text-sm font-bold mb-2">Password:</label>
                    <input type="password" id="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="********" readonly>
                    <p class="text-gray-500 text-xs italic">Password tidak ditampilkan untuk keamanan.</p>
                </div>
                <a href="{{ route('dashboard', ['username' => request()->query('username')]) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Kembali ke Dashboard</a>
            </div>
        </main>
    </div>
